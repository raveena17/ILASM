            ...
            for business in self.cleaned_data['business_unit']:
                ...
                if str(business).startswith('5G Canada'):
                    ...
                    if self.cleaned_data['type'] == 'A':
                        ...
                        if auto_code:
                            auto_code = UserProfile.objects.filter(
                                code__startswith='5GU').order_by('-code')
                    ...
                    if self.cleaned_data['type'] == 'A':
                        ...
                        if auto_code:
                            auto_code = UserProfile.objects.filter(
                                code__startswith='5GIN').order_by('-code')
...
class MyProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = ('date_of_joining', 'user', 'business_unit',
                   ...
                   'probation_period', 'document_check_list', 'date_of_resignation', 'date_of_relieving', 'document_check_list_others', 'division', 'comments', 'business_unit_code',)
