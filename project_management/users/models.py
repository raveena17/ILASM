...
class UserProfile(models.Model):
    ...
    PROBATION_PERIOD = (('1', _('1 Month')), ('2', _('2 Months')), ('3', _('3 Months')),
                        ('4', _('4 Months')), ('5', _('5 Months')
                                               ), ('6', _('6 Months')), ('7', _('7 Months')),
                        ('8', _('8 Months')), ('9', _('9 Months')), ('10',
                                                                     _('10 Months')), ('11', _('11 Months')),
                        ('12', _('12 Months')))

    EMPLOYEE_TYPES = (('E', _('Permanent')), ('C', _('Contract')),
                      ('T', _('Trainee')), ('TP', _('Temporary')),('A', _('Employee')),('IN', _('Intern')),('C', _('Consultant')))
    ...
    TITLE = (('Mr', _('Mr')), ('Ms', _('Ms')),
             ('Mrs', _('Mrs')), ('Dr', _('Dr')))
    CONFIRMATION_STATUS = (('CONFIRMED', _('Confirmed')),
                           ('ONPROBATION', _('On Probation')))
    DIVISION = (('TECHNICAL', _('Technical')),
    ...
    fathers_name = models.CharField(
        _('Father''s Name'), blank=True, max_length=56, null=True)
    email_address_official = models.EmailField(
        _('Email Address (Personal)'), blank=True, max_length=56, null=True)
    ...
    business_unit_code = models.ForeignKey(BusinessUnit,
                                      related_name="%(app_label)s_%(class)s_business_unit_code",
                                      verbose_name=_('BusinessUnitCode'))   
    ...
    date_of_resignation = models.DateField(
        _('Date of resignation'), null=True, blank=True)

    date_of_relieving = models.DateField(
        _('Date of relieving'), null=True, blank=True)
    ...
    document_check_list_others = models.CharField(
    ...
    customer_code = models.CharField(
        ...
        null=True,
        blank=True)
    reporting_senior = models.CharField(
        _('Reporting_senior'),
        max_length=8,
        null=True,
        blank=True)
    reporting_senior_name = models.ForeignKey(
        User,
        blank=True,
        null=True,
        verbose_name=_('reporting_senior_name'),
        related_name="%(app_label)s_%(class)s_reporting_senior_name")
