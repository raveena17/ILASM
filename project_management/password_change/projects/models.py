...
class Project(ProjectDetail):
    ...
    billing_category = models.CharField(_('Billing Category'),
                                     max_length=120, choices=billed_or_not)
    ...
    unbilled_reason = models.TextField(max_length=1500, blank=True, null=True)
    
    billed_type = models.CharField(_('billed_type'), max_length=2, null=True,
                            blank=True, choices=BILLED_TYPES)
...
class ProjectBillingDetails(models.Model):
    ...
    category_or_not = ((MONTHLY, 'Monthly'), (BIMONTHLY, 'Bi-Monthly'))


    project_id = models.IntegerField(null=True, blank=True)
    billing_category = models.CharField(max_length=255,null=True, blank=True)
    ...
    category = models.CharField(_('Category'),
                                     max_length=120, choices=category_or_not,null=True, blank=True)
    other = models.TextField(max_length=1500, blank=True, null=True)
